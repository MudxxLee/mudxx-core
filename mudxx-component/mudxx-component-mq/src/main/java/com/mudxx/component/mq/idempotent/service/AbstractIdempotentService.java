package com.mudxx.component.mq.idempotent.service;
...
import com.mudxx.component.mq.idempotent.strategy.impl.NormalIdempotentStrategy;
import com.mudxx.component.mq.idempotent.strategy.impl.PerfectIdempotentStrategy;
