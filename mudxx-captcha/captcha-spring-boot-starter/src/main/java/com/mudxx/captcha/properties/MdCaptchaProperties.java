package com.mudxx.captcha.properties;
...
import static com.mudxx.captcha.properties.MdCaptchaProperties.PREFIX;
...
public class MdCaptchaProperties {
    public static final String PREFIX = "md.captcha";
     ...
     * 缓存类型redis/local/....
     */
    private CaptchaStorageTypeEnum cacheType = CaptchaStorageTypeEnum.local;
    /**
     * 历史数据清除开关
     */
     ...
     * 验证失败后，锁定时间间隔,s
     */
    private int reqGetLockSeconds = 60;

    /***
     * get接口一分钟内限制访问数
     */
    private int reqGetMinuteLimit = 60;
    ...
    public CaptchaStorageTypeEnum getCacheType() {
        return cacheType;
    }

    public void setCacheType(CaptchaStorageTypeEnum cacheType) {
