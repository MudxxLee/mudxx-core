package com.mudxx.tool.oci.modules.security.auth.example;
 ...
 */
public class AuthenticationProviderExample {

    public static OCIAuthenticationProviderModel getProviderModel() {
        /**
        ...
        String privateKey = "-----BEGIN PRIVATE KEY-----\n" +
                ...
                "-----END PRIVATE KEY-----";
        return new OCIAuthenticationProviderModel.Builder()
                .userId(userId)
                .tenancy(tenancy)
