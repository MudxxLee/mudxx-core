 ...
 */
public class OCIDeleteObjectRequest implements Serializable {
    private static final long serialVersionUID = -1361755006216004387L;
    private String namespaceName;
    private String bucketName;
    private String objectName;

    public OCIDeleteObjectRequest() {
    }

    private OCIDeleteObjectRequest(Builder builder) {
    ...
    public static final class Builder {
        ...
        public OCIDeleteObjectRequest build() {
            return new OCIDeleteObjectRequest(this);
        }
    }
}
